...
urlpatterns = patterns('',
    ...
    url(r'^streampunk/items/$', VisibleView.as_view(model=Item), name='list_items'),
    url(r'^streampunk/rooms/$', VisibleView.as_view(model=Room), name='list_rooms'),
    url(r'^streampunk/tags/$', VisibleView.as_view(model=Tag), name='list_tags'),
    ...
    url(r'^streampunk/kitrequests/$', AllView.as_view(model=KitRequest), name='list_kitrequests'),
