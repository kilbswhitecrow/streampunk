...
def make_default_Check(apps, schema_editor):
  ...
  model(result=ilist, module="person_clashes", name="Person clashes", description="List items where the same person is programmed on two concurrent items.").save()
  ...
  model(result=ilist, module="items_unsatisfied_kitreq", name="Items with unsatisfied kit requests", description="List items for which there are kit requests unsatisfied by either room or item assignments.").save()
  ...
  model(result=plist, module="person_no_avail", name="People without availability", description="List people who have no availability info entered.").save()
  model(result=plist, module="person_not_avail", name="People unavailable", description="List people who are programmed on items outside their available times.").save()
